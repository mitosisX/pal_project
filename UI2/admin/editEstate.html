                ...
                <li class="nav-item active">
                    ...
                    >
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="createUser.html"
                                >Manage users</a
                            >
                                ...
                                <div class="col-md-6">
                                    <div class="col-lg-12">
                                        <div class="card fw-bold text-muted">
                                            ...
                                            <div class="card-body">
                                                <h4
                                                    class="card-title font-weight-bold text-justify-center"
                                                ></h4>
                                                <table
                                                    class="table table-striped fw-bold text-muted"
                                                >
                                                    <thead>
                                                        <tr>
                                                            <!-- <th scope="col">#</th> -->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card fw-bold text-muted">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <table
                                                    class="table table-striped text-muted fw-bold"
                                                >
                                                    <thead>
                                                        <tr>
                                                            <!-- <th scope="col">#</th> -->
