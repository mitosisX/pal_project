...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="editCrop.php">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Crop</h1>
                                                        ...
                                                        <form class="px-md-2 ">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                ...
                                                                <select  name="type" class="type form-control">
                                                                  <option ></option>
                                                                  <option value="Estate Manager">North east</option>
                                                                  <option value="WareHouse Manager">South</option>
