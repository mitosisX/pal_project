...
<head>
    ...
    <title>edit Esrate details</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="createEstate.html">Create estate</a>
                        <a class="collapse-item" href="editEstate.html">Manage estates</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Estate Details</h1>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="p-5">
                                                        <div class="text-center">
                                                            <h1 class="h4 text-gray-900 mb-4">Edit Estate Details</h1>
                                                        </div>
                                                        <form class="px-md-2 ">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                              <label for="validationCustom01" class="form-label">Estate Manager</label>
