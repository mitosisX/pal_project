...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="estate.php">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manager tasks:</h6>
                        <a class="collapse-item" href="submitRequest.php">Submit request</a>
                                                        ...
                                                        <form class="px-md-2 ">
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                ...
                                                                <select  name="type" class="form-control">
                                                                  <option ></option>
                                                                  <option value="Fertilizer">Fertlizer</option>
                                                            ...
                                                            <div class="form-outline mb-4">
                                                              ...
                                                              <input type="date" class="form-control" name="name" id="validationCustom01" value="" required>
                                                            ...
                                                            <div class="form-outline mb-4">
                                                                ...
                                                                <select  name="package" class="type form-control">
                                                                  <option ></option>
