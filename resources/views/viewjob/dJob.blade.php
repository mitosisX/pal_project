        ...
        <div class="bg-light py-6" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3 ">
                ...
                <a href="#" class="list-group-item list-group-item-action bg-transparent second-text fw-bold "><i
                        ...
                        <a href="#" class="list-group-item list-group-item-action bg-transparent text-success fw-bold active"><i
            ...
            <div class="container-fluid px-4 pr-5">
              ...
              <div class="row g-3 my-2">
                <div class="col-md-12">
                    <div class="col-lg-12">
                        <div class="card">
                            <h3 class="card-header fw-bold text-muted">DELIVERY JOBS</h3>
                            <div class="card-body">
